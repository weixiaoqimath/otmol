...
import scipy.sparse
from ._sot_cython import perform_sOT_log_cython
...
#def perform_sOT_log(G, a, b, eps, options):
    """Python wrapper for the Cython implementation of perform_sOT_log.
    ...
    -------
    tuple
        (P, f, g) where P is the transport plan, f and g are the dual variables
    """
#    return perform_sOT_log_cython(G, a, b, eps, options)
