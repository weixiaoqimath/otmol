...
"""
   ...
   for i in swaps:
      for j in reflects:
         if is_proper_rotation(i, j): # added by Xiaoqi
   ...
   write_to_xyz(num_atoms, './arbalign_output/no_reflection/'+name, b_final_labels, b_final_coords)
   print "Best alignment of " + str(args.xyz2) + " with " + str(args.xyz1) + " is written to ./arbalign_output/no_reflection/" + str(name)
   return FinalRMSD
